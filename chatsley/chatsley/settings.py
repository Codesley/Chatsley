"""
Django settings for chatsley project.
...
SECRET_KEY = 'django-insecure-o^+fikdz9uz5gu6*l#^-070a9uhma=4!07zj=v9bc-iteiopf@'
...
LOGIN_URL = '/login/'
# Django built in functions and where to redirect to
